...
class mainWin(QWidget):
    def __init__(self,mp):
        ...
        """
        super().__init__()
        self.carCheck(mp)  # 直接调用视频检测方法

    def carCheck(self,mp):
        print("车流检测")
        # 读取加载视频
        ...
        output_file = os.path.join('result_mp4s2', file_name)
